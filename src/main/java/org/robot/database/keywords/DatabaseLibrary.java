...
public class DatabaseLibrary  {
	...
	@RobotKeyword("Establish the connection to the database. This is mandatory before any of "
			...
			+ "of course.\n\n"
			+ "Example: "
			+ "| Connect To Database | _com.mysql.jdbc.Driver_ | _jdbc:mysql://my.host.name/myinstance_ | _UserName_ | _ThePassword_ |\n")
	@ArgumentNames({ "driverClassName", "connectString", "dbUser", "dbPassword" })

...
Suite Setup       Set order and start H2 server
Suite Teardown    Stop H2 Server
Resource          common.robot
Library           Remote    http://127.0.0.1:62022/    WITH NAME    RemoteDatabaseLibrary
...
*** Keywords ***
Set order and start H2 server
    Set Library Search Order    RemoteDatabaseLibrary
    Start H2 server